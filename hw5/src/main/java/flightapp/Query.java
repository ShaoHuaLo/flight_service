...
//
//        Itinerary[] itineraries = new Itinerary[numberOfItineraries];
//        int count = 0;
...
//                PreparedStatement dfStatement = conn.prepareStatement(dfQuery);
//
//                dfStatement.clearParameters();
//                dfStatement.setInt(1, numberOfItineraries);
//                dfStatement.setString(2, originCity);
//                dfStatement.setString(3, destinationCity);
//                dfStatement.setInt(4, dayOfMonth);
//
//                ResultSet result = dfStatement.executeQuery();
//
//                while (result.next()) {
//                    int result_fid = result.getInt("fid");
//                    int result_dayOfMonth = result.getInt("day_of_month");
//                    String result_carrierId = result.getString("carrier_id");
//                    String result_flightNum = result.getString("flight_num");
//                    String result_originCity = result.getString("origin_city");
//                    String result_destCity = result.getString("dest_city");
//                    int result_time = result.getInt("actual_time");
//                    int result_capacity = result.getInt("capacity");
//                    int result_price = result.getInt("price");
//
//
...
//            }
//
//            boolean needForIndirectFlight = !directFlight && (numberOfItineraries > count);
//            if (needForIndirectFlight) {
//                int numberOfIndirectFlight = numberOfItineraries - count;
...
//                PreparedStatement indfStatement = conn.prepareStatement(indfQuery);
//                indfStatement.clearParameters();
//                indfStatement.setInt(1, numberOfItineraries);
//                indfStatement.setString(2, originCity);
//                indfStatement.setString(3, destinationCity);
//                indfStatement.setInt(4, dayOfMonth);
//
//                ResultSet result = indfStatement.executeQuery();
//
//                while (result.next()) {
//                    int result_fid1 = result.getInt(1);
//                    int result_fid2 = result.getInt(10);
//                    int result_dayOfMonth = result.getInt(2);
//                    String result_carrier1 = result.getString(3);
//                    String result_carrier2 = result.getString(11);
//                    String result_flightNum1 = result.getString(4);
//                    String result_flightNum2 = result.getString(12);
//                    String result_org1 = result.getString(5);
//                    String result_org2 = result.getString(13);
//                    String result_dest1 = result.getString(6);
//                    String result_dest2 = result.getString(14);
//                    int result_time1 = result.getInt(7);
//                    int result_time2 = result.getInt(15);
//                    int result_cap1 = result.getInt(8);
//                    int result_cap2 = result.getInt(16);
//                    int result_price1 = result.getInt(9);
//                    int result_price2 = result.getInt(17);
//
//
//                    sb.append("Itinerary ").append(count)
//                            .append(": 2 flight(s), ").append(result_time1 + result_time2)
//                            .append(" minutes\n")
//                            .append("ID: ").append(result_fid1)
//                            .append(" Day: ").append(result_dayOfMonth)
//                            .append(" Carrier: ").append(result_carrier1)
//                            .append(" Number: ").append(result_flightNum1)
//                            .append(" Origin: ").append(result_org1)
//                            .append(" Dest: ").append(result_dest1)
//                            .append(" Duration: ").append(result_time1)
//                            .append(" Capacity: ").append(result_cap1)
//                            .append(" Price: ").append(result_price1)
//                            .append("\n")
//                            .append("ID: ").append(result_fid2)
//                            .append(" Day: ").append(result_dayOfMonth)
//                            .append(" Carrier: ").append(result_carrier2)
//                            .append(" Number: ").append(result_flightNum2)
//                            .append(" Origin: ").append(result_org2)
//                            .append(" Dest: ").append(result_dest2)
//                            .append(" Duration: ").append(result_time2)
//                            .append(" Capacity: ").append(result_cap2)
//                            .append(" Price: ").append(result_price2)
//                            .append("\n");
//
//                    itineraries[count] = new Itinerary(count, result_fid1, result_fid2, result_price1 + result_price2, result_dayOfMonth);
//                    count++;
//                }
//                indfStatement.close();
//            }
